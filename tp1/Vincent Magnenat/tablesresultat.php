<!-- Nom & Prénom: Magnenat Vincent 
     Classe: SM-C2B 
     Sujet: Test de PHP sur les tables d'additions et de multiplications
     Commentaires: Oriane Martin et moi avons travaillé ensemble sur ce test 
-->
...
<?php
    ...
    if($chiffre<2 || $chiffre>16){
        echo '<a href="javascript:history.back()">Le chiffre doit être entre 2 et 16. Réessayez!</a>';}
    else {
?>
    ...
    <html lang="fr">
        ...
        <head>
            <meta charset="UTF-8">
            <title>PHP Test: Table de multiplications et additions</title>
        </head>
        ...
        <body>
            ...
            <table border="1">
                ...
                <?php	for ($j=1; $j<=$chiffre; $j++) { ?>
                        <td style="background:#999999;"><?php echo $j; ?></td>
                <?php	} ?>
                    </th>
